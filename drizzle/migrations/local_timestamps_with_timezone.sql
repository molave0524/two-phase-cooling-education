-- Migration: Change LOCAL timestamp columns to timestamp(6) with time zone
-- Adds timezone awareness to all timestamp columns
...
-- accounts table (if it has timestamps)
-- Note: accounts table may not have created_at/updated_at, check schema first
