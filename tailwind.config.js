  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glass:
          '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -1px rgb(0 0 0 / 0.06), inset 0 1px 0 rgb(255 255 255 / 0.1)',
        equipment:
          '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -2px rgb(0 0 0 / 0.05), inset 0 1px 0 rgb(255 255 255 / 0.1)',
      },
      ...
      backgroundImage: {
        'cooling-gradient':
          'linear-gradient(135deg, rgb(14 165 233 / 0.1) 0%, rgb(59 130 246 / 0.05) 100%)',
        'thermal-gradient':
          'linear-gradient(135deg, rgb(239 68 68 / 0.1) 0%, rgb(220 38 38 / 0.05) 100%)',
        'glass-gradient':
          'linear-gradient(135deg, rgb(255 255 255 / 0.1) 0%, rgb(255 255 255 / 0.05) 100%)',
        'circuit-pattern':
          "url(\"data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23e2e8f0' fill-opacity='0.05'%3E%3Cpath d='M20 20.5V18H0v-2h20v-2H0v-2h20v-2H0V8h20V6H0V4h20V2H0V0h22v20h2V0h2v20h2V0h2v20h2V0h2v20h2v2H20v-1.5zM0 20h2v20H0V20z'/%3E%3C/g%3E%3C/svg%3E\")",
      },
