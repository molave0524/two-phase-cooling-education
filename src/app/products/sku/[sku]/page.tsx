...
export default function ProductBySKUPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white', paddingTop: '20px' }}>
      {/* Breadcrumb */}
      <div
        style={{ backgroundColor: '#f8fafc', padding: '16px 0', borderBottom: '1px solid #e2e8f0' }}
      >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <p style={{ color: '#92400e', fontWeight: '500', margin: 0 }}>
                This product version is no longer available for purchase. You previously ordered
                this item.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div>
          ...
          <p
            style={{ fontSize: '20px', color: '#475569', marginBottom: '24px', lineHeight: '1.5' }}
          >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <span style={{ fontSize: '16px', fontWeight: '500', color: '#0f172a' }}>Quantity:</span>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor: isAvailableForPurchase ? 'pointer' : 'not-allowed',
                  fontSize: '18px',
                  fontWeight: 'bold',
                  color: '#64748b',
                }}
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor:
                    !isAvailableForPurchase || quantity >= product.stockQuantity
                      ? 'not-allowed'
                      : 'pointer',
                  fontSize: '18px',
                  fontWeight: 'bold',
      ...
      {product.description && (
        ...
        >
          <h2
            style={{ fontSize: '28px', fontWeight: 'bold', color: '#0f172a', marginBottom: '24px' }}
          >
            Product Description
          </h2>
