...
export default function CartPage() {
  ...
  return (
    <div className='min-h-screen bg-secondary-50'>
      {/* Header - Technology Page Style */}
      <section className='py-20 bg-slate-50' aria-labelledby='cart-heading'>
        <div className='container-max section-padding'>
          <div className='text-center space-y-4'>
            <h1 id='cart-heading' className='text-3xl font-bold text-secondary-900'>
              Shopping Cart
            </h1>
            {itemCount > 0 && (
