    ...
    <div className='space-y-12'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-lg text-secondary-600 max-w-3xl mx-auto'>
          Get instant expert guidance on two-phase cooling technology. Our AI assistant helps with
          technical questions, configuration advice, and educational support.
        </p>
      </div>
