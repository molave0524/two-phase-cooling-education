      ...
      <div className='text-center space-y-8'>
        <div className='space-y-4'>
          ...
          <p className='text-xl text-secondary-600 max-w-3xl mx-auto'>
            Join thousands of enthusiasts, students, and professionals discovering the revolutionary
            potential of two-phase cooling technology.
          </p>
        </div>
          ...
          {CTA_OPTIONS.map(option => (
            <div
              ...
              className={`relative p-8 rounded-equipment cursor-pointer transition-all hover:scale-105 ${
                selectedCTA === option.id ? 'ring-2 ring-primary-400 shadow-xl' : 'hover:shadow-lg'
              }`}
              style={{
      ...
      <div className='bg-secondary-50 rounded-equipment p-8'>
        <div className='text-center space-y-6'>
          ...
          <p className='text-secondary-900 max-w-2xl mx-auto'>
            Structured curricula designed for different experience levels and learning goals. Start
            where you are, progress at your pace.
          </p>
          ...
          <div className='grid md:grid-cols-3 gap-6 mt-8'>
            {LEARNING_PATHS.map((path, index) => (
              <div
                key={index}
                className='bg-white rounded-equipment p-6 hover:shadow-lg transition-shadow'
              >
                <div className='space-y-4'>
                  <div className='text-primary-600 flex justify-center'>{path.icon}</div>
                  ...
                  <button className='btn-primary w-full text-sm'>Start Path</button>
                </div>
              </div>
            ))}
          </div>
